...
const cloudProviders = [
  {
    name: "AWS",
    description: "Amazon Web Services - Leading cloud platform with 200+ services",
    features: ["EC2 & Lambda", "S3 Storage", "RDS & DynamoDB", "EKS & ECS"]
  },
  {
    name: "Azure",
    description: "Microsoft Azure - Enterprise-grade cloud computing",
    features: ["Virtual Machines", "Azure Functions", "Cosmos DB", "AKS"]
  },
  {
    name: "GCP",
    description: "Google Cloud Platform - Innovation-driven infrastructure",
    features: ["Compute Engine", "Cloud Functions", "BigQuery", "GKE"]
  },
  {
    name: "Private Cloud",
    description: "On-premises cloud solutions for complete control",
    features: ["VMware", "OpenStack", "Kubernetes", "Custom Solutions"]
  }
];
...
const cloudServices = [
  {
    ...
    description: "Seamless migration of workloads to cloud with minimal disruption to your business operations."
  },
  {
    icon: Server,
    title: "Infrastructure as Code",
    description: "Automated infrastructure provisioning using Terraform, CloudFormation, and Pulumi."
  },
  {
    icon: Shield,
    title: "Cloud Security",
    description: "Comprehensive security posture management, compliance, and threat detection."
  },
  {
    icon: BarChart,
    title: "Cost Optimization",
    description: "Right-sizing, reserved instances, and architectural optimizations for cost savings."
  },
  {
    icon: Settings,
    title: "Cloud Architecture",
    description: "Well-architected solutions designed for scalability, reliability, and performance."
  },
  {
    icon: Lock,
    title: "Disaster Recovery",
    description: "Business continuity solutions with automated failover and data replication."
  }
];
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10">
          <FadeInUp>
            ...
            <p className="text-lg text-foreground/80 max-w-3xl mb-8">
              Accelerate your digital transformation with comprehensive cloud services. 
              We help you design, migrate, and manage cloud infrastructure across all 
              major platforms for optimal performance and cost efficiency.
            </p>
            
            <div className="flex flex-wrap gap-4">
              <Link to="/contact" className="inline-flex items-center gap-2 px-8 py-4 gradient-primary text-primaryfont-semibold rounded-lg glow-primary hover:opacity-90 transition-opacity">
                Start Cloud Journey
